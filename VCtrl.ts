...
// namespace vsdk {
    ...
    class VCtrlIns {
        ...
        public popView(mediator: {new():VMediator}, view: {new():BaseView}, data?: any, cb?: ()=>void): void {
            mgrView.__showView__(mediator, view, data, vsdk.OPEN_VIEW_OPTION.OVERLAY, 0, cb);
        }
        ...
        public addLayer(mediator: {new(): VMediator}, view: {new(): BaseView}, zOrder?: number, data?: any, cb?: ()=>void): void {
            mgrView.__showLayer__(mediator, view, data, vsdk.OPEN_VIEW_OPTION.LAYER, zOrder, cb);
        }
